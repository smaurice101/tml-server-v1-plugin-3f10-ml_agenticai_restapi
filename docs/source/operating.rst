...
.. important::
   VIPERHOST_PRODUCE=0.0.0.0, VIPERPORT_PRODUCE=5050, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=35077, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=45577, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=35497, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=33937, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=46621, HPDEHOST=127.0.1.1, HPDEPORT=43399, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=36567

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-3077-tml-server-v1-plugin-3f10-ml_agenticai_restapi,solution_preprocessing_ml_agenticai_restapi_dag-tml-server-v1-plugin-3f10, python-preprocess-751-tml-server-v1-plugin-3f10-ml_agenticai_restapi,solution_preprocessing_ml_agenticai_restapi_dag-tml-server-v1-plugin-3f10, python-ml-4027-tml-server-v1-plugin-3f10-ml_agenticai_restapi,solution_preprocessing_ml_agenticai_restapi_dag-tml-server-v1-plugin-3f10, python-predict-5354-tml-server-v1-plugin-3f10-ml_agenticai_restapi,solution_preprocessing_ml_agenticai_restapi_dag-tml-server-v1-plugin-3f10, python-ai-4552-tml-server-v1-plugin-3f10-ml_agenticai_restapi,solution_preprocessing_ml_agenticai_restapi_dag-tml-server-v1-plugin-3f10, python-agenticai-3635-tml-server-v1-plugin-3f10-ml_agenticai_restapi,solution_preprocessing_ml_agenticai_restapi_dag-tml-server-v1-plugin-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-preprocess-agenticai, viper-ml, viper-predict
