...
.. important::
   VIPERHOST_PRODUCE=0.0.0.0, VIPERPORT_PRODUCE=5050, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=39507, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=41453, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=32961, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=36851, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=35547, HPDEHOST=127.0.1.1, HPDEPORT=46559, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=40565

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-82-tml-server-v1-plugin-3f10-ml_agenticai_restapi,solution_preprocessing_ml_agenticai_restapi_dag-tml-server-v1-plugin-3f10, python-preprocess-9651-tml-server-v1-plugin-3f10-ml_agenticai_restapi,solution_preprocessing_ml_agenticai_restapi_dag-tml-server-v1-plugin-3f10, python-ml-2471-tml-server-v1-plugin-3f10-ml_agenticai_restapi,solution_preprocessing_ml_agenticai_restapi_dag-tml-server-v1-plugin-3f10, python-predict-6489-tml-server-v1-plugin-3f10-ml_agenticai_restapi,solution_preprocessing_ml_agenticai_restapi_dag-tml-server-v1-plugin-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-preprocess-agenticai, viper-ml, viper-predict
