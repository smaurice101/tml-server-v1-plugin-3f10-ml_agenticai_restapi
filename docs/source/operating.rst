[tml-server-v1-plugin-3f10-ml_agenticai_restapi] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [tml-server-v1-plugin-3f10-ml_agenticai_restapi] container is NOT running**.

.. tip::
   You must have your [tml-server-v1-plugin-3f10-ml_agenticai_restapi] container running before connecting to the Visualization and Airflow URLs.
...
[tml-server-v1-plugin-3f10-ml_agenticai_restapi] Github Repo
---------------
...
.. important::
   solution_preprocessing_ml_agenticai_restapi_dag-tml-server-v1-plugin-3f10
...
.. important::
   VIPERHOST_PRODUCE=0.0.0.0, VIPERPORT_PRODUCE=5050, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=33419, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=34479, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=38815, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=42009, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=36621, HPDEHOST=127.0.1.1, HPDEPORT=35885, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=46101

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-5217-tml-server-v1-plugin-3f10-ml_agenticai_restapi,solution_preprocessing_ml_agenticai_restapi_dag-tml-server-v1-plugin-3f10, python-preprocess-5308-tml-server-v1-plugin-3f10-ml_agenticai_restapi,solution_preprocessing_ml_agenticai_restapi_dag-tml-server-v1-plugin-3f10, python-ml-2947-tml-server-v1-plugin-3f10-ml_agenticai_restapi,solution_preprocessing_ml_agenticai_restapi_dag-tml-server-v1-plugin-3f10, python-predict-2039-tml-server-v1-plugin-3f10-ml_agenticai_restapi,solution_preprocessing_ml_agenticai_restapi_dag-tml-server-v1-plugin-3f10, python-ai-2753-tml-server-v1-plugin-3f10-ml_agenticai_restapi,solution_preprocessing_ml_agenticai_restapi_dag-tml-server-v1-plugin-3f10, python-agenticai-1215-tml-server-v1-plugin-3f10-ml_agenticai_restapi,solution_preprocessing_ml_agenticai_restapi_dag-tml-server-v1-plugin-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-preprocess-agenticai, viper-ml, viper-predict
