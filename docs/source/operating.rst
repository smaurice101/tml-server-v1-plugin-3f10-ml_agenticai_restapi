...
.. important::
   VIPERHOST_PRODUCE=0.0.0.0, VIPERPORT_PRODUCE=5050, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=46759, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=41097, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=44619, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=45457, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=37763, HPDEHOST=127.0.1.1, HPDEPORT=34955, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=45463

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-4094-tml-server-v1-plugin-3f10-ml_agenticai_restapi,solution_preprocessing_ml_agenticai_restapi_dag-tml-server-v1-plugin-3f10, python-preprocess-1957-tml-server-v1-plugin-3f10-ml_agenticai_restapi,solution_preprocessing_ml_agenticai_restapi_dag-tml-server-v1-plugin-3f10, python-ml-5888-tml-server-v1-plugin-3f10-ml_agenticai_restapi,solution_preprocessing_ml_agenticai_restapi_dag-tml-server-v1-plugin-3f10, python-predict-7805-tml-server-v1-plugin-3f10-ml_agenticai_restapi,solution_preprocessing_ml_agenticai_restapi_dag-tml-server-v1-plugin-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-preprocess-agenticai, viper-ml, viper-predict
