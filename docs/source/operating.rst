...
.. important::
   VIPERHOST_PRODUCE=0.0.0.0, VIPERPORT_PRODUCE=5050, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=42037, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=46251, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=34293, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=33015, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=45757, HPDEHOST=127.0.1.1, HPDEPORT=39509, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=39345

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-7826-tml-server-v1-plugin-3f10-ml_agenticai_restapi,solution_preprocessing_ml_agenticai_restapi_dag-tml-server-v1-plugin-3f10, python-preprocess-3699-tml-server-v1-plugin-3f10-ml_agenticai_restapi,solution_preprocessing_ml_agenticai_restapi_dag-tml-server-v1-plugin-3f10, python-ml-633-tml-server-v1-plugin-3f10-ml_agenticai_restapi,solution_preprocessing_ml_agenticai_restapi_dag-tml-server-v1-plugin-3f10, python-predict-5286-tml-server-v1-plugin-3f10-ml_agenticai_restapi,solution_preprocessing_ml_agenticai_restapi_dag-tml-server-v1-plugin-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-preprocess-agenticai, viper-ml, viper-predict
